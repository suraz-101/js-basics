...
let r = sentence.indexOf("My"); // indexOf method is used which helps to returns the position of the first letter occurance of the respective word from the sentence
